		...
		<ul class='nav navbar-nav side-nav'>
			...
			<li>
				...
				<ul id='prod_demo' class='collapse'>
					...
					<li><a href='add_products.php'>Add Product(s)</a></li>
					<li><a href='edit_products.php'>Edit Product(s)</a></li>
				</ul>  						
			...
			<li>
				...
				<ul id='bill_demo' class='collapse'>
					<li><a href='all_invoices.php'>All Invoices</a></li>
					<li><a href='add_invoice.php'>Add Invoice</a></li>
					<li><a href='edit_invoice.php'>Edit Invoice</a></li>
			...
			<li>
				<a>
					...
					<span class='feat_title'>Suppliers</span>
				...
				<ul id='vend_demo' class='collapse'>
					<li><a href='all_suppliers.php'>All Suppliers</a></li>
					<li><a href='add_supplier.php'>Add Supplier</a></li>
					<li><a href='edit_supplier.php'>Edit Supplier</a></li>
				</ul>
			</li>
			<li>
				<a data-toggle='collapse' data-target='#ord_demo'>
				...
				<ul id='ord_demo' class='collapse' data-toggle='collapse' data-target='#ord_demo'>
					<li><a>
						<span class='feat_title'>Customer</span>
						<span class='arrow_in material-icons' data-toggle='collapse' data-target='#cust_ord_demo'>keyboard_arrow_right</span></a>
						
						<ul id='cust_ord_demo' class='collapse'>
							<li><a href='cust_order_cart.php'>All Orders</a></li>
							<li><a href='edit_cust_cart.php'>Edit Order</a></li>
						</ul>
					</li>
					<li><a>
						<span class='feat_title'>Supplier</span>
						<span class='arrow_in material-icons' data-toggle='collapse' data-target='#sup_ord_demo'>keyboard_arrow_right</span></a>
						
						<ul id='sup_ord_demo' class='collapse'>
							<li><a href='sup_order_cart.php'>All Orders</a></li>
							<li><a href='add_sup_cart.php'>Add Order</a></li>
							<li><a href='edit_sup_cart.php'>Edit Order</a></li>
						</ul>
					</li>
				</ul>
			...
			<li>
				<a>
					<i class='material-icons'>group</i><br/>
					<span class='feat_title'>Employees</span>
			...
			<li>
				...
				<ul id='tag_demo' class='collapse'>
					<li><a href='#'>All Product Tags</a></li>
					<li><a href='#'>Add Product Tag</a></li>
					<li><a href='#'>Edit Product Tag</a></li>
				</ul>
			</li>
			<li>
				<a>
