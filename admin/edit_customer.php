...
<div id='page-wrapper'>
	...
	<div class='container'>
		...
		<div class='row heading_page'>
			...
			<div class='col-md-12'> Edit Customer </div>
		</div>
		
		<div class='row edit_cust_form'>
			<form class='col-md-12 row' action='' method='post' enctype='multipart/form-data' >
				...
				<div class='col-md-6 edit_cust_btn'>
		...
		<div class='row edit_cust_address_form'>
			<form class='col-md-12 row' action='' method='post' enctype='multipart/form-data' >
				...
				<div class='col-md-12 edit_cust_address_btn'>
