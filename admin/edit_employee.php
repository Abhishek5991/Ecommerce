...
<div id='page-wrapper'>
	...
	<div class='container'>
		...
		<div class='row heading_page'>
			...
			<div class='col-md-12'> Edit Employee </div>
		</div>
		
		<div class='row edit_emp_form'>
			<form class='col-md-12 row' action='' method='post' enctype='multipart/form-data' >
				...
				<div class='col-md-6 form-group'>
					<label for='emp_amount_recieved'>Amount Received :</label>
					<input type='text' class='form-control'>
				</div>
				...
				<div class='col-md-6 edit_emp_btn'>
		...
		<div class='row edit_emp_address_form'>
			<form class='col-md-12 row' action='' method='post' enctype='multipart/form-data' >
				...
				<div class='col-md-12 edit_emp_address_btn'>
