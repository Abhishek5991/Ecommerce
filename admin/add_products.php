...
<div id='page-wrapper'>
	...
	<div class='container'>
		...
		<div class='row heading_page'>
			...
			<div class='col-md-12'> Add Products </div>
		...
		<div class='row add_product_form'>
			<form class='col-md-12 row' action='' method='post' enctype='multipart/form-data' >
				...
				<div class='col-md-6 add_prod_btn'>
		...
		<div class='row add_sub_product_form'>
			<form class='col-md-12 row' action='' method='post' enctype='multipart/form-data' >
				<div class='col-md-12 row sub-heading_page'>							
					<div class='col-md-12'> Add Sub-Products </div>
					<div class='col-md-1'></div>
				...
				<div class='col-md-12 add_sub_prod_btn'>
					<button type='submit' class='save_btn' >Save</button>
					<button type='submit' class='cancel_btn' >Cancel</button>
