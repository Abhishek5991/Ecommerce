...
<div id='page-wrapper'>
	...
	<div class='container'>
		...
		<div class='row heading_page'>
			...
			<div class='col-md-12'> Add Supplier </div>
		</div>
		
		<div class='row add_sup_form'>
			<form class='col-md-12 row' action='' method='post' enctype='multipart/form-data' >
				...
				<div class='col-md-6 add_sup_btn'>
		...
		<div class='row add_sup_address_form'>
			<form class='col-md-12 row' action='' method='post' enctype='multipart/form-data' >
				...
				<div class='col-md-12 add_sup_address_btn'>
